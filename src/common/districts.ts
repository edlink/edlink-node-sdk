import { BearerTokenAPI, District, Person, RequestOptionsGet, RequestOptionsPaging } from '../types';
...
export class Districts {
     ...
     */
    async *list(options: RequestOptionsPaging = {}): AsyncGenerator<District> {
     ...
     * @param options Provide a `limit` for the max number of results
     */
    async *listAdministrators(district_id: string, options: RequestOptionsPaging = {}): AsyncGenerator<Person> {
